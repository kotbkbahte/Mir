...
{
    create_simple_button("PlayGame", m_Textures[BUTTON_PLAYGAME], 0, 1.2f);
    create_simple_button("Settings", m_Textures[BUTTON_SETTINGS], 0, 0.0f);
    create_simple_button("Quit", m_Textures[BUTTON_QUIT], 0, -1.2f);
}
